  ...
  return (
    <>
      ...
      {!user && (
        ...
        <img
          src="https://images.unsplash.com/photo-1513013156887-d2bf241c8c82?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
          alt=""
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
          <div className="max-w-2xl text-center">
            <h2 className="text-4xl font-bold tracking-tight sm:text-6xl">DOGGO DASH</h2>
